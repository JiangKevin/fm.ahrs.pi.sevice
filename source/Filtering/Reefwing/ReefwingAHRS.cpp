...
void ReefwingAHRS::reset()
{
    ...
    _att[ 0 ]                            = 1.0f;
    _att[ 1 ]                            = 0.0f;  // Reset complementary filter state
    _att[ 2 ]                            = 0.0f;
    _att[ 3 ]                            = 0.0f;
...
void ReefwingAHRS::classicUpdate()
{
    ...
    if ( rollDenominator < 1e-6 || pitchDenominator < 1e-6 )
    {
        return;
    }
...
void ReefwingAHRS::madgwickUpdate( SensorData d, float deltaT )
{
    ...
    s0 = -_2q2 * ( 2.0f * q1q3 - _2q0q2 - d.ax ) + _2q1 * ( 2.0f * q0q1 + _2q2q3 - d.ay ) - _2bz * _q.q2 * ( _2bx * ( 0.5f - q2q2 - q3q3 ) + _2bz * ( q1q3 - q0q2 ) - d.mx ) + ( -_2bx * _q.q3 + _2bz * _q.q1 ) * ( _2bx * ( q1q2 - q0q3 ) + _2bz * ( q0q1 + q2q3 ) - d.my )
         + _2bx * _q.q2 * ( _2bx * ( q0q2 + q1q3 ) + _2bz * ( 0.5f - q1q1 - q2q2 ) - d.mz );
    s1 = _2q3 * ( 2.0f * q1q3 - _2q0q2 - d.ax ) + _2q0 * ( 2.0f * q0q1 + _2q2q3 - d.ay ) - 4.0f * _q.q1 * ( 1.0f - 2.0f * q1q1 - 2.0f * q2q2 - d.az ) + _2bz * _q.q3 * ( _2bx * ( 0.5f - q2q2 - q3q3 ) + _2bz * ( q1q3 - q0q2 ) - d.mx )
         + ( _2bx * _q.q2 + _2bz * _q.q0 ) * ( _2bx * ( q1q2 - q0q3 ) + _2bz * ( q0q1 + q2q3 ) - d.my ) + ( _2bx * _q.q3 - _4bz * _q.q1 ) * ( _2bx * ( q0q2 + q1q3 ) + _2bz * ( 0.5f - q1q1 - q2q2 ) - d.mz );
    s2 = -_2q0 * ( 2.0f * q1q3 - _2q0q2 - d.ax ) + _2q3 * ( 2.0f * q0q1 + _2q2q3 - d.ay ) - 4.0f * _q.q2 * ( 1.0f - 2.0f * q1q1 - 2.0f * q2q2 - d.az ) + ( -_4bx * _q.q2 - _2bz * _q.q0 ) * ( _2bx * ( 0.5f - q2q2 - q3q3 ) + _2bz * ( q1q3 - q0q2 ) - d.mx )
         + ( _2bx * _q.q1 + _2bz * _q.q3 ) * ( _2bx * ( q1q2 - q0q3 ) + _2bz * ( q0q1 + q2q3 ) - d.my ) + ( _2bx * _q.q0 - _4bz * _q.q2 ) * ( _2bx * ( q0q2 + q1q3 ) + _2bz * ( 0.5f - q1q1 - q2q2 ) - d.mz );
    s3 = _2q1 * ( 2.0f * q1q3 - _2q0q2 - d.ax ) + _2q2 * ( 2.0f * q0q1 + _2q2q3 - d.ay ) + ( -_4bx * _q.q3 + _2bz * _q.q1 ) * ( _2bx * ( 0.5f - q2q2 - q3q3 ) + _2bz * ( q1q3 - q0q2 ) - d.mx ) + ( -_2bx * _q.q0 + _2bz * _q.q2 ) * ( _2bx * ( q1q2 - q0q3 ) + _2bz * ( q0q1 + q2q3 ) - d.my )
         + _2bx * _q.q1 * ( _2bx * ( q0q2 + q1q3 ) + _2bz * ( 0.5f - q1q1 - q2q2 ) - d.mz );
