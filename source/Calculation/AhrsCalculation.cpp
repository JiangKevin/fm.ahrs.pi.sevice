...
bool AhrsCalculation::SolveAnCalculation( SENSOR_DB* sensor_data, SENSOR_DB* original_sensor_data )
{
    ...
    //
    if ( ! calculateSurfaceVelocity( original_sensor_data, deltaTime, false, true ) )
    {
        return false;
    }
    //
...
//
bool AhrsCalculation::calculateSurfaceVelocity( SENSOR_DB* sensor_data, float dt, bool is_lp, bool is_trapezoid )
{
